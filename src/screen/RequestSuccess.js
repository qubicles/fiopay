    ...
    render() {
        ...
        return (
            <ScrollView style={{ flex: 1,backgroundColor: '#4099DC'}}>
               ...
               <View style={[transformStyle],{backgroundColor:'#4099DC',height: '100%' }}>
                ...
                <View style={{marginLeft:30,marginRight:30}}>
                        ...
                        <TouchableOpacity onPress={()=>this.done()} style={{marginTop:20,marginBottom:20, justifyContent: 'center',alignSelf: 'center',height:60,width: '85%',backgroundColor: '#4099DC',borderRadius:30,}}>
               ...
               <View style={styles.viewPart}>
                   ...
                   <Text style={{color: 'rgba(0,0,0,0.4)',paddingTop: 30,paddingLeft: 30,fontSize: 16,fontFamily: 'ProximaNova-Bold'}}>Amount</Text>
                    ...
                    <TouchableOpacity onPress={()=>this.confirm()} style={{marginBottom:50, justifyContent: 'center',alignSelf: 'center',height:64,width: '85%',backgroundColor: '#4099DC',borderRadius:30,}}>
