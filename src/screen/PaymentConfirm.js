        ...
        return (
            <ScrollView style={{ flex: 1,backgroundColor: '#3653b8'}}>
               <View style={{width:'124%',position: 'absolute',height: '100%',backgroundColor: '#415fc9',transform: [{skewX: '25deg'}]}}></View>
                    ...
                    <Text style={{fontSize: 33,marginLeft: 25,color: '#fff',fontFamily: 'ProximaNova-Extrabld'}}>Review Payment</Text>

            {/* <ScrollView style={{position: 'absolute',paddingTop:100,flex: 1,paddingBottom: 1.3}}> */}
               ...
               <View style={[transformStyle],{backgroundColor:'#415fc9',height: '120%' }}>
                    ...
                    <Text style={{color: 'gray',marginTop: 10,fontSize: 20,textAlign: 'center',fontFamily:'ProximaNova-Medium'}}>You Successfully Sent Money</Text>
                        ...
                        <View style={{flexDirection: 'row',marginTop: 20,justifyContent: 'center',borderRadius: 8,alignItems: 'center'
                            ,marginLeft: 40,marginRight: 40,borderWidth: 0.3,height: 89}}>
                                    ...
                                    <Text style={{fontSize: 30,color: '#415fc9',fontFamily: 'ProximaNova-Extrabld'}}>1.131FIO</Text>
                        ...
                        <TouchableOpacity onPress={()=>this.done()} style={{marginTop:100,marginBottom:20, justifyContent: 'center',alignSelf: 'center',height:60,width: '85%',backgroundColor: '#415fc9',borderRadius:30,}}>
