...
import { Text, View, ScrollView, Image,Animated,TouchableOpacity ,Dimensions} from 'react-native'
        ...
        return (
            ...
            <Image source ={require('../images/bg3.png')} style={{width: screenWidth  ,
              aspectRatio: 1 ,height: '100%', position: 'absolute',resizeMode: 'stretch', }}/>
                    ...
                    <Text style={{fontSize: 33,marginLeft: 25,color: '#fff',fontFamily: 'ProximaNova-Extrabld'}}>Review Request</Text>

            {/* <ScrollView style={{position: 'absolute',paddingTop:100,flex: 1}} > */}
               <View style={styles.viewPart}>
                   ...
                   <Text style={{color: 'rgba(0,0,0,0.4)',paddingTop: 30,paddingLeft: 30,fontSize: 16,fontFamily: 'ProximaNova-Bold'}}>Amount</Text>
                    ...
                    <TouchableOpacity  style={{borderWidth: 0.3,backgroundColor: '#4099DC',marginLeft:30,marginRight:30,marginTop:10 ,width: 94,borderColor: 'gray',height: 37,padding: 10,borderRadius: 10}}>
                    ...
                    <TouchableOpacity onPress={()=>this.confirm()} style={{marginTop:40,marginBottom:20, justifyContent: 'center',alignSelf: 'center',height:64,width: '85%',backgroundColor: '#4099DC',borderRadius:30,}}>
               ...
               <View style={[transformStyle],{backgroundColor:'#4099DC',height: '120%' }}>
                  ...
                  <View style={{alignItems: 'center',marginTop: 60,justifyContent: 'center'}}>
                      <Image source={require('../images/successSky.png')} style={{height:100,width:100,}}/>
                    </View>
                  ...
                  <Text style={{color: 'gray',marginTop: 10,fontSize: 20,textAlign: 'center',fontFamily:'ProximaNova-Medium'}}>You Successfully Sent Money</Text>
                        ...
                        <View style={{flexDirection: 'row',marginTop: 20,justifyContent: 'center',borderRadius: 8,alignItems: 'center'
                            ,marginLeft: 40,marginRight: 40,borderWidth: 0.3,height: 89}}>
                                    ...
                                    <Text style={{fontSize: 30,color: '#48a5e9',fontFamily: 'ProximaNova-Extrabld'}}>FIO</Text>
                ...
                <View style={{marginLeft:30,marginRight:30}}>
                        ...
                        <TouchableOpacity onPress={()=>this.done()} style={{marginTop:100,marginBottom:20, justifyContent: 'center',alignSelf: 'center',height:60,width: '85%',backgroundColor: '#4099DC',borderRadius:30,}}>
