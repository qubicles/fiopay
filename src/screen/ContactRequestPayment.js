...
export default class ContactRequestPayment extends Component {
    constructor(props){
        super(props);
        this.state={
            connectedValue: '',
        ...
        return (
          ...
          aspectRatio: 1 ,height: '100%', position: 'absolute',resizeMode: 'stretch', }}/>
                <TouchableOpacity 
                    ...
                    <Text style={{fontSize: 33,marginLeft: 25,color: '#fff',fontFamily: 'ProximaNova-Extrabld'}}>Request Payment</Text>
               <View style={styles.viewPart}>
                    ...
                    <Text style={{color: '#429cdf',fontSize: 24,marginLeft: 30,marginTop: 10,fontFamily: 'ProximaNova-Extrabld'}}>Amount</Text>
